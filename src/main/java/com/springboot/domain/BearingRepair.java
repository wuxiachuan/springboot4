...
public class BearingRepair implements Serializable {
    ...
    private String  closeStateLeft;
    private String  axleGapLeft;
    private String  appearanceLeft;
    private String  uncapReasonLeft;
    private String  unloadReasonLeft;
    private String  unloadDateLeft;
    private String  repairProgressLeft;
    private String  worker;
    private String  unloaderLeft;
    private String  unloaderRight;
    private String  isFinish;
    private String  finishTime;
    private String  closeStateRight;
    ...
    public String getBearingBoxType() {
        return bearingBoxType;
    }

    public void setBearingBoxType(String bearingBoxType) {
        this.bearingBoxType = bearingBoxType;
    }
    ...
    public String getCloseStateLeft() {
        return closeStateLeft;
    }

    public void setCloseStateLeft(String closeStateLeft) {
        this.closeStateLeft = closeStateLeft;
    }
    ...
    public String getAppearanceLeft() {
        return appearanceLeft;
    }

    public void setAppearanceLeft(String appearanceLeft) {
        this.appearanceLeft = appearanceLeft;
    }
    ...
    public String getUnloadReasonLeft() {
        return unloadReasonLeft;
    }

    public void setUnloadReasonLeft(String unloadReasonLeft) {
        this.unloadReasonLeft = unloadReasonLeft;
    }

    public String getUnloadDateLeft() {
        return unloadDateLeft;
    }

    public void setUnloadDateLeft(String unloadDateLeft) {
        this.unloadDateLeft = unloadDateLeft;
    }

    public String getRepairProgressLeft() {
        return repairProgressLeft;
    }

    public void setRepairProgressLeft(String repairProgressLeft) {
        this.repairProgressLeft = repairProgressLeft;
    }
    ...
    public String getUnloaderLeft() {
        return unloaderLeft;
    }

    public void setUnloaderLeft(String unloaderLeft) {
        this.unloaderLeft = unloaderLeft;
    }

    public String getUnloaderRight() {
        return unloaderRight;
    }

    public void setUnloaderRight(String unloaderRight) {
    ...
    public String getCloseStateRight() {
        return closeStateRight;
    }

    public void setCloseStateRight(String closeStateRight) {
        this.closeStateRight = closeStateRight;
    }
    ...
    public String getAppearanceRight() {
        return appearanceRight;
    }

    public void setAppearanceRight(String appearanceRight) {
        this.appearanceRight = appearanceRight;
    }
    ...
    public String getUnloadReasonRight() {
        return unloadReasonRight;
    }

    public void setUnloadReasonRight(String unloadReasonRight) {
        this.unloadReasonRight = unloadReasonRight;
    }

    public String getUnloadDateRight() {
        return unloadDateRight;
    }

    public void setUnloadDateRight(String unloadDateRight) {
        this.unloadDateRight = unloadDateRight;
    }

    public String getRepairProgressRight() {
        return repairProgressRight;
    }
